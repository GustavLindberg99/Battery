...
int main(int argc, char **argv){
    ...
    (void) translator.load(":/translations/battery_" + QLocale::system().name().section('_', 0, 0));
    app.installTranslator(&translator);
    QTranslator baseTranslator;
    (void) baseTranslator.load(":/translations/qtbase_" + QLocale::system().name().section('_', 0, 0));
